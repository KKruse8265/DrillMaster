...
public class Test41 {
	...
	public static void main(String[] args) {
		...
		coll.put(2,4);	//put auf einen bestehenden key �berschreibt den Value f�r diesen Keys
		...
		//coll.add(1);	//Bei Sets wird k e i n Dupilkat hinzugef�gt add liefert in dem Fall false
